...
async def read_particular_campaign(id: int, session: SessionDep):
...
@app.post("/campaign", response_model=Response[Campaign], status_code=201)
async def add_campaign(campaign : CampaignCreate, session : SessionDep):
...
@app.put("/campaign/{id}", status_code=201, response_model=Response[Campaign])
...
@app.delete("/campaign/{id}", status_code=201)
